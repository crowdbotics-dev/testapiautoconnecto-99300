...
## Project Structure
    ...
    ├── testapiautoconnecto_99300  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_99300`
...
2. Clone this repo and `cd testapiautoconnecto_99300`
